...
#ifndef BSP_COMPONENTS_SPI_EEPROM_SPI_EEPROM_H_
#define BSP_COMPONENTS_SPI_EEPROM_SPI_EEPROM_H_
...
#define EEPROM_CS_HIGH()    HAL_GPIO_WritePin(EEPROM_SS_GPIO_Port, EEPROM_SS_Pin, GPIO_PIN_SET)
#define EEPROM_CS_LOW()     HAL_GPIO_WritePin(EEPROM_SS_GPIO_Port, EEPROM_SS_Pin, GPIO_PIN_RESET)
...
#endif /* BSP_COMPONENTS_SPI_EEPROM_SPI_EEPROM_H_ */
